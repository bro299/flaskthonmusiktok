...
import yt_dlp
import os
import urllib.parse  # Tambahkan ini untuk meng-encode URL
...
@app.route('/music')
def music():
    return render_template('https://donmustik.onrender.com')
...
def download():
    ...
    try:
        with yt_dlp.YoutubeDL(ydl_opts) as ydl:
            ...
            title = info_dict.get('title', 'No Title')  # Berikan default 'No Title' jika tidak ada judul
    ...
    return jsonify({
        ...
        'audioUrl': audio_url,  # URL file MP3 yang diunduh
    })
